...
guides.add(Direction.HORIZONTAL, 10);
// This creates a guide object...!!!!!!!!
guides.add(Direction.HORIZONTAL, 100);
// Which is indexed at 0?
var guide10 = guides[0];
alert("Async?");
guide10.remove();

// GUIDES ARE STORED LIKE A QUEUE, FIFO